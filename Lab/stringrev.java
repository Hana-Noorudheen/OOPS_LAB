...
class LinkList {
    ...
    // Concatanation
    public void concatenate(LinkList obj) {
        Link cur1 = first;
        Link cur2 = obj.first;
...
public class q4_b_2k19 {
    public static void main(String args[]) throws IOException {
        LinkList[] obj;
        obj = new LinkList[2];
        obj[0] = new LinkList();
        obj[1] = new LinkList();
        int choice, value, value1, i;
        ...
        do {
            ...
            System.out.println("0.First LinkList");
            System.out.println("1.2nd LinkList");
            ...
            do {
                ...
                if(i==1)
                System.out.println("8.CONCATANATION");
                System.out.println("Press 9 for completing");
                ...
                case 1: {
                    ...
                    obj[i].insertFirst(value);
                    break;
                }
                case 2: {
                    System.out.println("Enter the data");
                    value = Integer.parseInt(in.readLine());
                    obj[i].insertLast(value);
                    break;
                }
                case 3: {
                    ...
                    obj[i].insert(value1, value);
                    break;
                }
                case 4: {
                    int d = obj[i].deleteFirst();
                    System.out.println(d + " is Deleted");
                    break;
                }
                case 5: {
                    int d = obj[i].deleteLast();
                    System.out.println(d + " is Deleted");
                    break;
                }
                case 6: {
